...
/**
 * Dataset export view. The in-app two-layer *recording* capture (issue #66) was
 * removed in the DicTeX/Lab split (see pivot_dictex_lab_split.md): dataset
 * building and benchmarking move to the separate DicTeX Lab app, and DicTeX
 * stays a lean consumer dictation tool. Only the local export (#44) of
 * already-captured corrections remains here, until the Lab takes it over.
 */
